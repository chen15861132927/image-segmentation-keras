...
{
	string templatepath = "C://Dev//GithubOpenCV//GradientDirectionMatch//Searchimg2//Template_2.jpg";
	...
	fastNccMatch.LearnPattern(templateImage);
	...
	while (imageIndex <= 10)
	{
		...
		//string searchImagepath = "C://Dev//GithubOpenCV//GradientDirectionMatch//Searchimg2//11.bmp";
		...
		vector<s_SingleTargetMatch> outFind(0);
		float ct = fastNccMatch.Match(searchImage, outFind);
