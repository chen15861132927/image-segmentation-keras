...
class DeepConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28),
                 ...
                 conv_param_4 = {'filter_num':32, 'filter_size':6, 'pad':2, 'stride':1},
                 conv_param_5 = {'filter_num':64, 'filter_size':3, 'pad':1, 'stride':1},
                 conv_param_6 = {'filter_num':64, 'filter_size':3, 'pad':1, 'stride':1},
                 hidden_size=50, output_size=10):
        # 初始化权重===========
        # 各层的神经元平均与前一层的几个神经元有连接（TODO:自动计算）
        pre_node_nums = np.array([1*3*3, 16*3*3, 16*3*3, 32*3*3, 32*6*6, 64*3*3, 64*4*4, hidden_size])
        ...
        self.params['W7'] = wight_init_scales[6] * np.random.randn(64*3*3, hidden_size)
